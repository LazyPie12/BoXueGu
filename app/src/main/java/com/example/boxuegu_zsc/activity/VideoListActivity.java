...
import com.example.boxuegu_zsc.adapter.VideoListAdapter;
        ...
        adapter = new VideoListAdapter(this, new VideoListAdapter.OnSelectListener() {
            ...
            public void onSelect(int position, ImageView iv) {
                ...
                if (TextUtils.isEmpty(videoPath)) {
                    ...
                    // 跳转到视频播放界面
                    Intent intent=new Intent(VideoListActivity.this, com.example.boxuegu_zsc.activity.VideoPlayActivity.class);
